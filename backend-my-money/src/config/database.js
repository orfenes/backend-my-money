...
module.exports = mongoose.connect('mongodb://127.0.0.1:27080/mymoney');

mongoose.Error.messages.general.required = "O atributo '{PATH}' é obrigatorio";
mongoose.Error.messages.Number.min = "O '{VALUE}' informado é menor que o limite minimo '{MIN}'.";
mongoose.Error.messages.Number.max = "O '{VALUE}' informado é maior que o limite permitido '{MAX}'.";
